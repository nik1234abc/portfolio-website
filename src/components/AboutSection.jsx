    ...
    <MotionSection id="about" className="mx-auto max-w-7xl px-6 py-14 lg:px-8">
      <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="glass-panel p-7 sm:p-8">
          <SectionHeading
            eyebrow="About Me"
            title={<span className="text-[color:var(--lux-gold)]">Backend engineering with enterprise accountability</span>}
          ...
          <div className="mt-6 border-t border-[color:var(--lux-border)] pt-6">
            ...
            <h3 className="text-[color:var(--lux-gold)] mt-3 font-display text-xl font-bold">Bengal College of Engineering and Technology</h3>
        ...
        <div className="grid gap-6">
          <div className="glass-panel p-7">
            ...
            <h3 className="text-[color:var(--lux-gold)] mt-3 font-display text-2xl font-bold">Tata Consultancy Services (TCS)</h3>
